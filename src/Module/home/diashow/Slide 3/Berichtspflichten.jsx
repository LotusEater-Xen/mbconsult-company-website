...
export default function Berichtspflichten() {
  
  return (
    <a href="Berichtspflichten" className=" card card-diashow2 m-5 md:ml-2">
                <figure>
                  <img
                ...
                <div className="card-body">
                  <h2 className="card-header">Berichtspflichten</h2>
